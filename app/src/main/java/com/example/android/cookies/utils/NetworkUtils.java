...
public final class NetworkUtils {
    ...
    private static final String CALENDAR = "/calendar.json";
    private static final String API_KEY = "apikey";
    private static final String API_KEY_VALUE = "someRandomString";
    ...
    private static URL buildUrlWithLatitudeLongitude(Double latitude, Double longitude) {
        Uri weatherQueryUri = Uri.parse(EVENTS_BASE_URL).buildUpon()
